...
class PartyDirectoryProcessor:
    ...
    def process_nama_dir(self, base_path:str, year:str, sijil_name:str,party_dir: str, party_info: PartyName):
        ...
        for pdf in pdfs:
            try:
                ...
                self.process_nama_pdf(f"{base_path}/{year}/{sijil_name}/{pdf}",base_path, year, pdf,party_dir, party_info)
            except Exception as e:
    ...
    def process_nama_pdf(self,path:str,base_path:str, year:str, pdf:str,party_dir: str, party_info: PartyName):
        ...
        adapter_id = 'a1c38507be5e'  # Replace with your actual adapter ID
