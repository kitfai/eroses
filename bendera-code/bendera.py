...
class PartyDirectoryProcessor:
    ...
    def process_sijil_dir(self,base_path:str, year:str,party_dir:str,party_info:PartyName):
        ...
        for sijil_type_dir in directories:
            if 'bendera' in sijil_type_dir.lower() :
                self.process_bendera_dir(base_path,year,sijil_type_dir,party_dir,party_info) #process bendera type
                break
            else:
                continue
    ...
    def process_bendera_dir(self, base_path:str, year:str, sijil_name:str, party_dir:str,party_info:PartyName):
        ...
        for pdf in pdfs:
            try:
                ...
                self.process_bendera_pdf(f"{base_path}/{year}/{sijil_name}/{pdf}",base_path, year, pdf,party_dir,party_info)
            except Exception as e:
                logger.error(f"Error in process_bendera_dir process: {str(e)}")

    def process_bendera_pdf(self,path:str,base_path:str, year:str, pdf:str , party_dir:str ,party_info:PartyName):
        ...
        try:
            ...
            benderaData.party_name = party_dir
            if party_info:
                benderaData.party_id = party_info.id
