...
class TextractCustomQueriesAdapter:
    ...
    def analyze_document_with_adapter(
        ...
        try:
            ...
            response = self.textract_client.start_document_analysis(
                ...
                QueriesConfig={
                    'Queries': [
                        {'Text': "What is the Alamat Asal?"},
                        {'Text': "What is the Alamat Baharu?"},
                        {'Text': "What is the Nombor PPM?"},
                        {'Text': "What is the No Rujukan PPM?"},
    ...
    def _process_blocks(self, blocks: List[Dict], results: Dict):
        ...
        '''
        query_mapping = {
            'What is the Alamat Asal?': 'organization_ori_address',
            'What is the Alamat Baharu?': 'organization_new_address',
            'What is the Tarikh Kuatkuasa?': 'organization_date',
            "What is the Nombor PPM?": 'ppm_no',
            "What is the No Rujukan PPM?": 'organization_no',
...
class PartyDirectoryProcessor:
    ...
    def process_sijil_specific_party(self, party_dir: str, party_info:PartyName) :
        ...
        base_path = f"{self.root_directory}/{party_dir}/Cawangan/Sijil/SKMA"
        result = {
            'directory_name': 'SKMA',
            'subdirectories': {}
        }
    ...
    def process_years(self, base_path:str, party_dir:str ,party_info:PartyName):
        ...
        for year in directories: #process every year
            ...
            self.process_alamat_dir(base_path, year, party_dir, party_info)
    def process_sijil_dir(self,base_path:str, year:str , party_dir:str, party_info:PartyName):
        ...
        for sijil_type_dir in directories:
            if 'SKMA' in sijil_type_dir.lower() :
                self.process_alamat_dir(base_path,year,sijil_type_dir, party_dir, party_info) #process bendera type
                #break
            else:
                continue

    def process_alamat_dir(self, base_path:str, year:str, party_dir:str, party_info:PartyName):
        ...
        for pdf in pdfs:
            try:
                ...
                self.process_alamat_pdf(f"{base_path}/{year}/{pdf}", base_path, year, pdf,party_dir, party_info)
            except Exception as e:
    ...
    def process_alamat_pdf(self,path:str, base_path:str, year:str, pdf:str, party_dir:str, party_info:PartyName):
        ...
        adapter_id = 'da1ac79831c1'  # Replace with your actual adapter ID
